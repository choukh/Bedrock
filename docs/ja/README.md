...
- **数学的開発と文章** (`src/`、`docs/`、この `README`) およびブランドマーク (`site/static/favicon.svg`、`site/static/brand.svg`) は [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/) で許諾される。その Agda 開発は、従来型のソフトウェアではなく一篇の数学的文章として扱われる。
